...
async def main():
    ...
    print("\n----- Example 5: Using all_p and all_s -----")
    print(g5)
    print("Evaluated:", await evaluate(g5))

    g6 = s(objs)
    print("\n----- Example 6: Using all_s -----")
    print(g6)
    print("Evaluated:", await evaluate(g6))
    ...
    print("\n----- Example 9: Combining everything together -----")
    print(g9)
    print("Evaluated:", await evaluate(g9))
    ...
    g10 = w(p1) >> w(p2)
    print(g10)
    print("Evaluated:", await evaluate(g10))
    ...
    print(g11)
    print("Evaluated:", await evaluate(g11))    
